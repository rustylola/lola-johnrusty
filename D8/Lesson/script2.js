...
// results of calling a provided function on every element in 
// the array.
...
console.log(Worlds); // ['Hello', 'World!']
...
// The Object.values() method returns an array of a 
// given object's own enumerable property values.
const values = Object.values(person);
console.log(values);
// Output: ['John', 30, 'New York']

// The Math.max() function returns the largest of the zero or more numbers given as input parameters.
const maxNumbers = Math.max(10, 5, 20);
